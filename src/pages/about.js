...
export default function About() {
  return (
    <Layout>
      <SEO title="About Intersection" />
      <h1>About Intersection</h1>
      <h2>Our Mission</h2>
      <p>
        Intersection’s purpose is to engage and educate communities through
        social contact and raise awareness of social issues. Our projects will
        encourage dialogue that inspires cooperation and community cohesion.
      </p>
      <hr />
      ...
      <h4>Grace Radkins</h4>
      <p>
        Grace first learned about Intersection through the 2014 Printer’s Row
        ...
        archives of a local radio station.
      </p>

      <h4>Marlena Johnson</h4>
      <p>
        Marlena is the cofounder of Intersection, which stemmed out of the
        ...
        photography, and watching Golden Girls episodes over and over again.
      </p>

      <h4>Oscar Xuarez</h4>
      <p>
        Oscar has been working with the Human Library Chicago since the 2014
      ...
      <h4>Alan Ashbeck</h4>
      <p>
        Alan has been with the Intersection and the Human Library Chicago since
      ...
      <p>
        Marvin is a front-end developer and designer for Intersection. He
        assists by maintaining the server for Intersection, and the Human
        Library Chicago Chapter. In his spare time, he does subpar photography.
      </p>
    </Layout>
  )
}
